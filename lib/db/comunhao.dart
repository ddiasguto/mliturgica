...
class PelosPradosECampinas extends StatelessWidget {
  const PelosPradosECampinas({super.key});
  @override
...
class SacramentoDaComunhao extends StatelessWidget {
  const SacramentoDaComunhao({super.key});
  @override
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      const Music(cipher: 'D A/C# Bm Bm/A'),
      const Music(
          cipher: 'SENHOR, GRAÇAS E LOUVORES SEJAM DADOS A TODO MOMENTO'),
      const Music(cipher: 'G A D G'),
      ...
      const Music(
          cipher:
              'JESUS, O FILHO DA RAINHA. JESU........US, ROSTO DIVINO DO HOMEM'),
...
class CantarABelezaDaVida extends StatelessWidget {
  const CantarABelezaDaVida({super.key});
  @override
  Widget build(BuildContext context) {
    return Column(children: [
...
class ConhecoUmCoracao extends StatelessWidget {
  const ConhecoUmCoracao({super.key});
  @override
  Widget build(BuildContext context) {
    return Column(children: [
...
class PaoDaVida extends StatelessWidget {
  const PaoDaVida({super.key});
  @override
  Widget build(BuildContext context) {
    return Column(children: [
...
class ComoEsLindo extends StatelessWidget {
  const ComoEsLindo({super.key});
  @override
  Widget build(BuildContext context) {
    return Column(children: [
      const Music(cipher: 'D A/C# Bm Bm/A'),
...
class VouCantarTeuAmor extends StatelessWidget {
  const VouCantarTeuAmor({super.key});
  @override
  Widget build(BuildContext context) {
    return Column(children: [
