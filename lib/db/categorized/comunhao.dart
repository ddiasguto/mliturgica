...
Chant cantarABelezaDaVida = Chant(
    ...
    category: 'Comunhão',
    lyrics: [
      const Music(cipher: '1. Cantar a beleza da vida,'),
      const Music(cipher: 'presente do amor sem igual:'),
      const Music(cipher: 'Missão do teu povo escolhido!'),
      const Music(cipher: 'Senhor, vem livrar-nos do mal!'),
      const Music(cipher: ''),
      const Music(cipher: 'Vem dar-nos teu Filho, Senhor,'),
      const Music(cipher: 'Sustento no pão e no vinho'),
      const Music(cipher: 'E a força do Espírito Santo,'),
      const Music(cipher: 'unindo teu povo a caminho!'),
      const Music(cipher: ''),
      const Music(cipher: '2. Falar do teu filho às nações,'),
      const Music(cipher: 'vivendo como ele viveu:'),
      const Music(cipher: 'Missão do teu povo escolhido,'),
      const Music(cipher: 'Senhor, vem cuidar do que é teu!'),
      const Music(cipher: ''),
      const Music(cipher: '3. Viver o perdão sem medida,'),
      const Music(cipher: 'servir sem jamais condenar:'),
      const Music(cipher: 'Missão do teu povo escolhido,'),
      const Music(cipher: 'Senhor, vem conosco ficar!'),
      const Music(cipher: ''),
      const Music(cipher: '4. Erguer os que estão humilhados,'),
      const Music(cipher: 'doar-se aos pequenos e aos pobres:'),
      const Music(cipher: 'Missão do teu povo escolhido,'),
      const Music(cipher: 'Senhor, nossas forças redobre!'),
      const Music(cipher: ''),
      const Music(cipher: '5. Buscar a verdade e a justiça,'),
      const Music(cipher: 'nas trevas brilhar como a luz:'),
      const Music(cipher: 'Missão do teu povo escolhido,'),
      const Music(cipher: 'Senhor, nossos passos conduz!'),
      const Music(cipher: ''),
      const Music(cipher: '6. Andar os caminhos do mundo,'),
      const Music(cipher: 'plantando teu reino de paz:'),
      const Music(cipher: 'Missão do teu povo escolhido,'),
      const Music(cipher: 'Senhor, nossos passos refaz!'),
      const Music(cipher: ''),
      const Music(cipher: '7. Fazer deste mundo um só povo,'),
      const Music(cipher: 'fraterno, a serviço da vida:'),
      const Music(cipher: 'Missão do teu povo escolhido,'),
      const Music(cipher: 'Senhor, vem nutrir nossa lida!'),
    ],
    hasCypher: true,
    ciphers: [
      const Cifra(cipher: '      D                 A'),
      const Music(cipher: '1. Cantar a beleza da vida,'),
      const Cifra(cipher: '   Bm                   F#'),
      const Music(cipher: 'presente do amor sem igual:'),
      const Cifra(cipher: '   G            A7      D'),
      const Music(cipher: 'Missão do teu povo escolhido!'),
      const Cifra(cipher: '   E7                        A'),
      const Music(cipher: 'Senhor, vem livrar-nos do mal!'),
      verse(),
      const Cifra(cipher: '      D                 A'),
      const Music(cipher: 'Vem dar-nos teu Filho, Senhor,'),
...
Chant cancaoDoEspirito = Chant(
    ...
    category: 'Comunhão',
    lyrics: [
      const Music(cipher: '1. Deixa Jesus encher tua vida'),
      const Music(cipher: 'Com seu Espírito e seu amor'),
      const Music(cipher: 'Deixa que Ele te envolva em seu calor.'),
      const Music(cipher: 'Deixa Jesus cuidar das coisas'),
      const Music(cipher: 'Que atormentam o teu viver'),
      const Music(cipher: 'E com a luz Ele vira sobre teu ser.'),
      verse(),
      const Refrao(cipher: 'Ó, ó, ó, Cristo, meu Cristo,'),
      const Refrao(cipher: 'Vem em mim morar'),
      verse(),
      const Music(cipher: '2. Deixa Jesus encher tua vida'),
      const Music(cipher: 'Com seu Espírito e seu amor'),
      const Music(cipher: 'Encher teu coração de gozo e louvor'),
      const Music(cipher: 'Deixa Jesus cuidar das coisas'),
      const Music(cipher: 'Que te fazem infeliz, e andarás do'),
      const Music(cipher: 'modo como a Bíblia diz.'),
      verse(),
      const Refrao(cipher: 'Ó, ó, ó, Cristo, meu Cristo,'),
      const Refrao(cipher: 'Vem em mim morar'),
      verse(),
      const Music(cipher: '3. Ó vem cantar com alegria'),
      const Music(cipher: 'Encher de paz teu coração'),
      const Music(cipher: 'Ergue os braços e'),
      const Music(cipher: 'louva a Deus em oração'),
      const Music(cipher: 'A Ele dá tuas tristezas,'),
      const Music(cipher: 'desilusões e tua cruz,'),
      const Music(cipher: 'Então terás a vida'),
      const Music(cipher: 'em nome de Jesus.'),
      verse(),
      const Refrao(cipher: 'Ó, ó, ó, Cristo, meu Cristo,'),
      const Refrao(cipher: 'Vem em mim morar'),
    ],
    hasCypher: true,
    ciphers: [
      const Music(cipher: 'C7            F          G'),
      const Music(cipher: '1. BUSCA EM JESUS A PLENITUDE'),
      const Music(cipher: '         Em                 Am'),
      const Music(cipher: 'DO SEU ESPÍRITO E DO SEU AMOR.'),
      const Music(cipher: '           Dm       G7             C C7'),
      const Music(cipher: 'DEIXA QUE ELE TE ENVOLVA EM SEU CALOR.'),
      const Music(cipher: '        F                G'),
      const Music(cipher: 'DEIXA JESUS CUIDAR DAS COISAS'),
      const Music(cipher: '         Em             Am'),
      const Music(cipher: 'QUE ATORMENTAM O TEU VIVER.'),
      const Music(cipher: '       Dm       G7               C C7'),
      ...
      const Music(cipher: 'DEIXA JESUS CUIDAR DAS COISAS'),
      const Music(cipher: 'QUE TE FAZEM INFELIZ'),
...
Chant venhoSenhor = Chant(
    title: 'Venho, Senhor',
    category: 'Comunhão',
    lyrics: [
      const Music(cipher: 'Venho Senhor te receber agora'),
      const Music(cipher: 'Teu santo corpo, Senhor'),
      const Music(cipher: 'me enche do teu amor.'),
      const Music(cipher: 'Venho Senhor te receber agora'),
      const Music(cipher: 'Teu santo sangue, Senhor'),
      const Music(cipher: 'transborda meu coração Senhor.'),
      const Music(cipher: ''),
      const Music(cipher: 'E ao receber teu corpo e sangue Senhor'),
      const Music(cipher: 'Possa em mim brotar a paz, o amor e a salvação'),
      const Music(cipher: 'E no teu altar seremos um em comunhão'),
      const Music(cipher: 'És grande ó meu salvador.'),
      const Music(cipher: ''),
      const Music(cipher: 'Venho Senhor te receber agora'),
      const Music(cipher: 'Teu santo corpo,Senhor'),
      const Music(cipher: 'me enche do teu amor.'),
      ...
      const Music(cipher: 'transborda meu coração Senhor.'),
      const Music(cipher: ''),
      const Music(cipher: 'E ao receber teu corpo'),
      const Music(cipher: 'e sangue Senhor,'),
      const Music(cipher: 'Não se faça em mim'),
      const Music(cipher: 'motivo de condenação'),
      const Music(cipher: 'Mas se faça sim, Senhor'),
      const Music(cipher: 'presença tua em mim'),
      const Music(cipher: 'És grande ó meu Salvador.'),
    ],
    hasCypher: false,
    ciphers: []);
