...
Chant sacramentoDaComunhao =
    Chant(title: 'Sacramento da comunhão', category: 'Comunhão', ciphers: [
...
Chant cantarABelezaDaVida =
    Chant(title: 'Cantar a beleza da vida', category: 'Comunhão', ciphers: [
  const Music(cipher: 'D A Bm F#'),
  const Music(
      cipher: '1. CANTAR A BELEZA DA VIDA, PRESENTE DO AMOR SEM IGUAL:'),
  const Music(cipher: 'G A7 D E7 A'),
  const Music(
      cipher: 'MISSÃO DO TEU POVO ESCOLHIDO, SENHOR, VEM LIVRAR-NOS DO MAL!'),
  ...
  const Music(
      cipher: 'MISSÃO DO TEU POVO ESCOLHIDO, SENHOR, VEM CUIDAR DO QUE É TEU!'),
  const Music(
  ...
  const Music(
      cipher: '4. ERGUER OS QUE ESTÃO HUMILHADOS, DOAR-SE AOS PEQUENOS, AOS'),
  const Music(cipher: 'POBRES:'),
  const Music(
      cipher: 'MISSÃO DO TEU POVO ESCOLHIDO, SENHOR, NOSSAS FORÇAS REDOBRE!'),
  const Music(
      cipher: '5. BUSCAR A VERDADE, A JUSTIÇA, NAS TREVAS BRILHAR COMO A LUZ:'),
  const Music(
      cipher: 'MISSÃO DO TEU POVO ESCOLHIDO, SENHOR, NOSSOS PASSOS CONDUZ!'),
  const Music(
      cipher: '6. ANDAR OS CAMINHOS DO MUNDO, PLANTANDO O TEU REINO DE PAZ:'),
  const Music(
      cipher: 'MISSÃO DO TEU POVO ESCOLHIDO, SENHOR, NOSSOS PASSOS CONDUZ!'),
  const Music(
      cipher: '7. FAZER DESTE MUNDO UM SÓ POVO FRATERNO, A SERVIÇO DA VIDA:'),
  const Music(
      cipher: 'MISSÃO DO TEU POVO ESCOLHIDO, SENHOR, VEM NUTRIR NOSSA LIDA!'),
]);

Chant conhecoUmCoracao =
    Chant(title: 'Conheço um coração', category: 'Comunhão', ciphers: [
...
Chant paoDaVida = Chant(title: 'Pão da vida', category: 'Comunhão', ciphers: [
...
Chant comoEsLindo =
    Chant(title: 'Como és lindo', category: 'Comunhão', ciphers: [
  const Music(cipher: 'D A/C# Bm Bm/A'),
  ...
  const Music(
      cipher: 'TE OLHAR, TE TOCAR E TE DIZER: MEU DEUS, COMO ÉS LINDO! (2X)'),
...
Chant vouCantarTeuAmor =
    Chant(title: 'Vou cantar teu amor', category: 'Comunhão', ciphers: [
  ...
  const Music(
      cipher: 'CANTAR UM CANTO ENSINADO POR DEUS, COM POESIA ENSINAR NOSSA FÉ'),
  const Music(cipher: 'A E F#m B7'),
  const Music(
      cipher: 'PLANTAR O CHÃO, CULTIVAR O AMOR, COMO POETAS QUE QUEREM SONHAR'),
  const Music(cipher: 'E B7 C#m G#m'),
  const Music(
      cipher:
  ...
  const Music(cipher: 'QUERO SER SENHOR, NOVO HOMEM NASCIDO DO TEU CORAÇÃO'),
  const Music(
      cipher: 'VOU FALAR DO TEU CORAÇÃO, COM TERNURA NAS MÃOS E NA VOZ'),
  const Music(cipher: 'PROCLAMAR QUE A VIDA É BEM MAIS'),
  const Music(cipher: 'DO QUE AQUILO QUE O MUNDO ENSINA E CANTAR '),
...
Chant quandoTeuPaiRevelou =
    Chant(title: 'Quando teu pai revelou', category: 'Comunhão', ciphers: [
  ...
  const Music(cipher: 'Cheia de fé, de esperança e de amor, dizer sim a Deus'),
...
Chant vejamEuAndeiPelasVilas =
    Chant(title: 'Vejam, eu andei pelas vilas', category: 'Comunhão', ciphers: [
  const Music(cipher: 'C Am Dm'),
  const Music(cipher: 'VEJAM: EU ANDEI PELAS VILAS, APONTEI AS SAÍDAS'),
  const Music(cipher: 'G E Am'),
  const Music(cipher: 'COMO O PAI ME PEDIU. PORTAS EU CHEGUEI PARA ABRI-LAS,'),
  ...
  const Music(cipher: 'E FALEI DE MEU PAI. POBRES, A ESPERANÇA QUE É DELES'),
  ...
  const Music(cipher: 'PREPOTÊNCIA DOS QUE TEMEM O NOVO, QUAL PERIGO SEM FIM.'),
  const Music(cipher: 'VEJAM: EU QUEBREI AS ALGEMAS, LEVANTEI OS CAÍDOS,'),
  const Music(cipher: 'DO MEU PAI FUI AS MÃOS. LAÇOS, RECUSEI OS ESQUEMAS,'),
  const Music(cipher: 'EU NÃO QUERO OPRIMIDOS, QUERO UM POVO DE IRMÃOS.'),
  const Music(cipher: 'VEJAM: PROCUREI SER BEM CLARO; O MEU REINO É DIVERSO,'),
...
Chant tomaiComei = Chant(title: 'Tomai, comei', category: 'Comunhão', ciphers: [
  ...
  const Music(
      cipher: 'VIVEI NO AMOR! EU VOU PREPARAR, A CEIA NA CASA DO PAI. (2X)'),
...
Chant cancaoDoEspirito =
    Chant(title: 'Canção do espírito', category: 'Comunhão', ciphers: [
  const Music(cipher: 'C7 F G Em Am'),
  const Music(
      cipher: '1. BUSCA EM JESUS A PLENITUDE DO SEU ESPÍRITO E DO SEU AMOR.'),
  ...
  const Music(
      cipher: '2. DEIXA JESUS ENCHER TUA VIDA COM SEU ESPÍRITO E SEU AMOR.'),
  ...
  const Music(cipher: '3. Ó VEM CANTAR COM ALEGRIA ENCHER DE PAZ TEU CORAÇÃO.'),
...
Chant aBarca = Chant(title: 'A Barca', category: 'Comunhão', ciphers: [
  const Music(cipher: 'C G/B Am Am/G'),
  const Music(cipher: 'TU, TE ABEIRASTE DA PRAIA.'),
  const Music(cipher: 'F Dm G'),
  const Music(cipher: 'NÃO BUSCASTE NEM SÁBIOS NEM RICOS,'),
  const Music(cipher: 'C G/B Am'),
