...
Chant santoE = Chant(title: 'Santo, Santo É', category: 'Entrada', ciphers: [
  const Music(
      cipher:
...
Chant saanto = Chant(title: 'Saaanto, Saaanto', category: 'Entrada', ciphers: [
  const Music(cipher: 'Saanto, Saanto, Saanto é o Senhor. (bis)'),
  const Music(cipher: ''),
  const Music(cipher: '1-Senhor Deus do universo, o céu'),
  const Music(cipher: 'e terra proclamam vossa glória. Hosana nas alturas.'),
  const Music(cipher: ''),
...
Chant oSenhorESanto =
    Chant(title: 'O Senhor é Santo', category: 'Entrada', ciphers: [
  const Music(
      cipher:
...
Chant santo = Chant(title: 'Santo', category: 'Entrada', ciphers: [
  const Music(
      cipher:
