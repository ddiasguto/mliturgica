...
Chant taoSublime =
    Chant(title: 'Tão sublime sacramento', category: 'Adoração', ciphers: [
...
Chant emTuaPresenca =
    Chant(title: 'Em tua presença', category: 'Adoração', ciphers: [
...
Chant dianteDoRei =
    Chant(title: 'Diante do Rei', category: 'Adoração', ciphers: [
